...
require_once 'PieceEmployee.php';
...
class Main {
    ...
    public function empType($name, $address, $age, $companyName) {
        ...
        switch ($type) {
            ...
            case 3:
                ...
                $employee = new PieceEmployee($name, $address, $age, $companyName, $ratePerItem, $itemsProduced);
                $this->roster->addEmployee($employee);
                break;
            default:
                echo "Invalid input. Please try again.\n";
    ...
    public function updateEmployeeDetails($employee) {
        ...
        if ($employee instanceof CommissionEmployee) {
            ...
            echo "[4] Hourly Rate\n";
            echo "[5] Hours Worked\n";
        } elseif ($employee instanceof PieceEmployee) {
